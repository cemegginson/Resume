...
% Default font size of the document, change to 10pt to fit more text
\documentclass[11pt]{letter}

% Default font is the New Century Schoolbook PostScript font
% \usepackage{newcent}
% Uncomment this (while commenting the above line) to use the Helvetica font
%\usepackage{helvet}

% Margins
% Moves the top of the document 1 inch above the default
\topmargin=-1in
% Total height of the text on the page before text goes on to the next page,
% this can be increased in a longer letter
\textheight=8.5in
% Position of the left margin, can be negative or positive if you want more or
% less room
\oddsidemargin=-10pt
% Total width of the text, increase this if the left margin was decreased and
% vice-versa
\textwidth=6.5in

% Pushes the date (at the top) to the left, comment this line to have the date
% on the right
...
\begin{center}
  \large\bf Casey Megginson \\ % Your name
  % If you would like a horizontal line separating the name from the address,
